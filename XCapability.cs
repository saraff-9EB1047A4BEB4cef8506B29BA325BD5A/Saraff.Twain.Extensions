...
namespace Saraff.Twain.Extensions {
    ...
    public sealed class XCapability<T> {
        ...
        public void Set(T value) {
            this.Twain32.SetCap(this.Id,value);
        }
        ...
        public IEnumerable<XCapabilityValue<T>> Values {
            get {
                var _values = this.Twain32.GetCap(this.Id).ToEnumeration<T>();
        ...
        public TwQC IsSupported {
            get {
                return this.Twain32.IsCapSupported(this.Id);
            }
        }
        ...
        private Twain32 Twain32 {
            get {
                return this.DataSource.Twain32;
            }
        }
    }
}
