...
namespace Saraff.TwainX.Extensions {
    ...
    public sealed class XCapabilityValue<T> {
        ...
        public bool IsCurrent {
            get {
                return this.Value.Equals((T)this.TwainX.GetCurrentCap(this.Capability.Id));
            }
        }
        ...
        public bool IsDefault {
            get {
                return this.Value.Equals((T)this.TwainX.GetDefaultCap(this.Capability.Id));
            }
        }
        ...
        private TwainX TwainX {
            get {
                return this.Capability.DataSource.TwainX;
            }
        }
    }
}
